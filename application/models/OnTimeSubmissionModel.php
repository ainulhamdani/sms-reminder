...
class OnTimeSubmissionModel extends CI_Model{
    ...
    public function getDailyOnTime($range="",$fhw){
        $location = $this->LocationModel->getIntLocId($fhw);
        $result_data = array();
    ...
    public function getDailyOnTimeDesa($location="",$range="",$fhw){
        ...
        $locations = $this->LocationModel->getLocIdQuery($location);
    ...
    public function getOnTimeForm($mode="",$range="",$fhw){
        ...
        $locId = $this->LocationModel->getIntLocId($fhw);$location = $this->LocationModel->getLocIdQuery($locId);
    ...
    public function getOnTimeFormDesa($desa,$range,$fhw){
        ...
        $locId = $this->LocationModel->getLocIdAndDesabyDesa($desa);
        $location = $this->LocationModel->getLocIdQuery($locId);
        //make result array from the tables name
        $result_data = array();
        foreach ($locId as $user=>$desa){
            $data = array();
