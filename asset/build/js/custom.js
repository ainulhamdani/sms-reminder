	...
	/* CROPPER */
      ...
      $('form').submit(function(e) {
	   ...
	   /* CUSTOM NOTIFICATION */
		...
		function init_charts(args = null) {
			...
			if ($('.by_form').length ){
				...
				console.log("BY FORM DETECTED: "+$('.by_form').length);
				if(args!=null){
					var by_form = $('.by_form');
			...
			if ($('#thisWeekForms').length ){ 
			  ...
			  $.getJSON(window.location.origin+"/data/getthisweekforms", function (json) {
					...
					options: {
				  	...
				  	thisWeekForms.data.labels = json.labels;
			        thisWeekForms.data.datasets.push({
						label: '# of Votes',
						backgroundColor: "#26B99A",
						data: json.data
					});
					thisWeekForms.update();
					loading.hide();
			    });
			} 
